...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        SimplePointDao.createTable(db, ifNotExists);
        PloygonDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        SimplePointDao.dropTable(db, ifExists);
        PloygonDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(SimplePointDao.class);
        registerDaoClass(PloygonDao.class);
    }
