 ...
 */
public class PopupDialogMessage extends AlertDialog {
    private static final String TAG = "PopupDialogMessage";
    private View view;
    ...
    private int width;
    static PopupDialogMessage dialog;

    private TextView fromMsg;


    protected PopupDialogMessage(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
    ...
    public void  setFromMsg(String fromAndTime){
        if (fromMsg != null) {
            fromMsg.setText(fromAndTime);
        }
    }
    ...
    private void initView() {
        ...
        this.fromMsg = (TextView) view.findViewById(R.id.message_from_time);
     ...
     * @return PopupDialog
     */
    public static PopupDialogMessage create(Context context, String title, String message,
        ...
        PopupDialogMessage dialog = new PopupDialogMessage(context, cancelable, canceledOnTouchOutside);
    ...
    public static PopupDialogMessage create(Context context, String title, String message,
                                            String confirm, View.OnClickListener positiveClickListener) {
        PopupDialogMessage dialog = create(context, title, message, confirm, positiveClickListener, null, null,
                true, false, false);
        return dialog;
    }

    public static PopupDialogMessage create(Context context, String titles, String message, String str,
                                            String confirm, View.OnClickListener positiveClickListener) {
        PopupDialogMessage dialog = new PopupDialogMessage(context, true, false);
    ...
    public static PopupDialogMessage create(Context context, String title, String message, boolean bool,
                                            String confirm, View.OnClickListener positiveClickListener) {
        isleft = true;
        PopupDialogMessage dialog = create(context, title, message, confirm, positiveClickListener, null, null,
                true, false, false);
    ...
    public static PopupDialogMessage create(Context context, String title, String message,
                                            String confirm, View.OnClickListener positiveClickListener,
                                            String cancel, View.OnClickListener negativeClickListener) {
        PopupDialogMessage dialog = create(context, title, message, confirm, positiveClickListener, cancel, negativeClickListener,
                true, false, false);
        return dialog;
    }
     ...
     * @return PopupDialog
     */
    public static PopupDialogMessage create(Context context, int titleRes, int messageRes, int confirmRes, View.OnClickListener
